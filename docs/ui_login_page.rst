...
.. figure:: _static/login/UM_SER_1.png
   :alt: Login page.
   :target: _static/login/UM_SER_1.png

Both options will take you to the **Sign in** page. Provide your username and password to log in:

.. figure:: _static/login/UM_SER_2.png
   :alt: Login page.
   :target: _static/login/UM_SER_2.png
...
.. figure:: _static/login/UM_SER_3.png
   :alt: Login page.
   :target: _static/login/UM_SER_3.png
