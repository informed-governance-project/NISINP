...
# 	**Module selector**: By clicking it, a dropdown menu will appear showing the available modules 
...
#   **Settings**: This option takes you to the settings page. The content of the Settings page may vary depending on the type of user 
   ...
   :target: _static/user_manual_images/UM_SER_12.png
      ...
      - **Account**: By selecting the **Account** option, you can manage your account. 
       ...
       - **Security**: The Security menu takes you to the Account Security screen, 
          ...
          (this is strongly not recommended) two-factor authentication.
