...
Either way, you will get to the **Security Objectives Dashboard**, where you can create your security objectives.
The Security objectives dashboard is a central screen where you can manage all your security objectives.
...
.. figure:: _static/user_manual_images/UM_SER_42.png
...
aspects to find the entry you are looking for.

4.	**Filter**: You can search among your submission entries by Standard (NIS ENISA SO), Year of submission, Sectors, Status (Unsubmitted, Under review,
Passed, Passed and sent, Revision required, and Revision required and sent), and Submitter user (a list of users who submitted a security objective).
...
**Status, Last update, Submission date, Evaluation Framework, Creator, Sectors, Year, Progress**, and **Actions** (highlighted in yellow in the screenshot below).

.. figure:: _static/user_manual_images/UM_SER_46.png
   :alt: Column headers
...
.. figure:: _static/user_manual_images/UM_SER_47.png
   ...
   :target: _static/user_manual_images/UM_SER_47.png

7.	**Column settings**: By default, all columns listed in point six are displayed on the dashboard.
...
.. figure:: _static/user_manual_images/UM_SER_48.png
...
.. figure:: _static/user_manual_images/UM_SER_49.png
   :alt: Edit icon
   :target: _static/user_manual_images/UM_SER_49.png
...
.. figure:: _static/user_manual_images/UM_SER_51.png
   :alt: Duplicate a security objective
   :target: _static/user_manual_images/UM_SER_51.png

The selected entry is then duplicated and appears in the list.

.. figure:: _static/user_manual_images/UM_SER_109.png
   :alt: Duplicate a security objective
   :target: _static/user_manual_images/UM_SER_109.png

11.	**Access log**: For each entry, the access log displays all activities that occurred during the incident’s lifecycle.
If you hover your mouse over the **Log** icon (highlighted in yellow in the screenshot below), a tooltip labeled **Access log** will appear.

.. figure:: _static/user_manual_images/UM_SER_52.png
   :alt: Access log
   :target: _static/user_manual_images/UM_SER_52.png
...
.. figure:: _static/user_manual_images/UM_SER_53.png
   :alt: Access log - Date column
   :target: _static/user_manual_images/UM_SER_53.png

12.	**Download**: For each entry, you have the option to download it as a PDF document. If you hover your mouse over the **PDF** icon
(highlighted in yellow in the screenshot below), a tooltip will appear.
You can download the selected security objective by clicking the corresponding **Download** button.

.. figure:: _static/user_manual_images/UM_SER_54.png
   :alt: Access log - Date column
   :target: _static/user_manual_images/UM_SER_54.png

13.	**Delete**: You can delete the selected entry as long as the security objective has not yet been submitted.
Once it has been submitted, the delete icon becomes inactive. In the screenshot below, the top icon is active, while the bottom icon is inactive:

.. figure:: _static/user_manual_images/UM_SER_55.png
   :alt: Delete an entry
...
.. figure:: _static/user_manual_images/UM_SER_56.png
   ...
   :target: _static/user_manual_images/UM_SER_56.png
